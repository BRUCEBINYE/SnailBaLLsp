...
coi_MAE_emb = np.load("/data1/yebin/0.2_Species/BarcodeMAE/train_BarcodeMAE_embedding.npy")

coi_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/EDITED_Augmented_76577_All_used_Gastropoda_seqs_Taxinomy_sequences/cls_embedding.npy")
coi_index = np.array([i for i in range(coi_emb.shape[0])])

rn16s_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/Augmented_Other_Marker_16S_sequences/cls_embedding.npy")
rn16s_index = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/Augmented_Other_Marker_16S.txt", sep="\t")['Index'].values

h3_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/Augmented_Other_Marker_H3_sequences/cls_embedding.npy")
h3_index = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/Augmented_Other_Marker_H3.txt", sep="\t")['Index'].values

rn18s_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/Augmented_Other_Marker_18S_sequences/cls_embedding.npy")
rn18s_index = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/Augmented_Other_Marker_18S.txt", sep="\t")['Index'].values

its1_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/Augmented_Other_Marker_ITS1_sequences/cls_embedding.npy")
its1_index = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/Augmented_Other_Marker_ITS1.txt", sep="\t")['Index'].values

its2_emb = np.load("/data1/yebin/0.2_Species/snailBaLL/ERNIE-RNA/results/ernie_rna_representations/Augmented_Other_Marker_ITS2_sequences/cls_embedding.npy")
its2_index = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/Augmented_Other_Marker_ITS2.txt", sep="\t")['Index'].values

dfl = pd.read_csv("/data1/yebin/0.2_Species/SnailBaLLsp/data/EDITED_Augmented_76577_All_used_Gastropoda_seqs_Taxinomy_LabelSpecies.txt", sep="\t")
...
#state_dict = torch.load(f"{model_out_fold}/stage0_coi_only_BestAcc.pt", map_location=DEVICE)
